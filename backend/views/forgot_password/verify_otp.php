...
$sql = "SELECT * FROM admin_user_table WHERE admin_email_id=:admin_email_id";
$query = $con -> prepare($sql);
$query->bindParam(':admin_email_id', $admin_email_id, PDO::PARAM_STR);
if($query->execute()){
    $sql = "SELECT otp_created_at FROM admin_user_table WHERE admin_email_id=:admin_email_id AND otp = :otp";
    $query = $con -> prepare($sql);
    $query->bindParam(':admin_email_id', $admin_email_id, PDO::PARAM_STR);
